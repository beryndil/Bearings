...
{#if pending.cardOpen}
  ...
  <aside
    bind:this={cardEl}
    class="fixed bottom-4 right-4 z-30 flex max-h-[60vh] w-80 flex-col
  ...
  >
    ...
    <div class="flex-1 overflow-y-auto px-2 py-2">
      ...
      {:else if pending.error}
        <p class="px-2 py-3 text-xs text-rose-400">{pending.error}</p>
    ...
    <footer class="border-t border-slate-800 px-3 py-1.5 text-[10px] text-slate-500">
