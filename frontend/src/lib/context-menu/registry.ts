...
const MESSAGE_ACTIONS: readonly MenuActionDescriptor[] = [
  ...
  /** T2-11 — copy all fenced code blocks as plain text. */
  { id: MENU_ACTION_MESSAGE_COPY_CODE, section: MENU_SECTION_COPY },
  /** T2-11 — copy all valid JSON objects/arrays. */
  { id: MENU_ACTION_MESSAGE_COPY_JSON, section: MENU_SECTION_COPY },
  /** T1-05 — inline edit (user-role messages only; disabled for assistant/system). */
  { id: MENU_ACTION_MESSAGE_EDIT, section: MENU_SECTION_EDIT },
...
const TOOL_CALL_ACTIONS: readonly MenuActionDescriptor[] = [
  ...
  /** T1-07 — edit tool input JSON before re-submitting. */
  { id: MENU_ACTION_TOOL_CALL_EDIT_INPUT, section: MENU_SECTION_EDIT, advanced: true },
  /** T1-07 — raw JSON debug drawer. */
  { id: MENU_ACTION_TOOL_CALL_DEBUG, section: MENU_SECTION_VIEW, advanced: true },
];
...
const CODE_BLOCK_ACTIONS: readonly MenuActionDescriptor[] = [
  ...
  { id: MENU_ACTION_CODE_BLOCK_RUN, section: MENU_SECTION_PRIMARY },
];
...
const CHECKPOINT_ACTIONS: readonly MenuActionDescriptor[] = [
  ...
  { id: MENU_ACTION_CHECKPOINT_COMPARE, section: MENU_SECTION_VIEW },
...
const MESSAGE_MULTI_SELECT_ACTIONS: readonly MenuActionDescriptor[] = [
  { id: MENU_ACTION_MESSAGE_MULTI_SELECT_COPY, section: MENU_SECTION_COPY },
  { id: MENU_ACTION_MESSAGE_MULTI_SELECT_PIN, section: MENU_SECTION_ORGANIZE },
  { id: MENU_ACTION_MESSAGE_MULTI_SELECT_HIDE, section: MENU_SECTION_ORGANIZE, advanced: true },
  {
    id: MENU_ACTION_MESSAGE_MULTI_SELECT_DELETE,
    section: MENU_SECTION_DESTRUCTIVE,
    destructive: true,
  },
];
...
> = {
  ...
  [MENU_TARGET_MESSAGE_MULTI_SELECT]: MESSAGE_MULTI_SELECT_ACTIONS,
