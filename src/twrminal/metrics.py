"""Prometheus collectors for Twrminal.
...
messages_persisted = Counter(
    "twrminal_messages_persisted_total",
...
tool_calls_finished = Counter(
    "twrminal_tool_calls_finished_total",
...
ws_active_connections = Gauge(
    "twrminal_ws_active_connections",
    "Currently connected agent WebSockets.",
    registry=REGISTRY,
)

ws_events_sent = Counter(
    "twrminal_ws_events_sent_total",
